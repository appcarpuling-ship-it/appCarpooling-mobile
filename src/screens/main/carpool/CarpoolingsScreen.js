...
// pregunta que el usuario ya se hizo antes de abrir la app— y en tiles (2 grandes arriba +
// el resto chico abajo, mismo reparto que "Servicios" de Uber) en vez de filas de texto
// largo. El orden prioriza crear por sobre revisar lo ya creado.
